...
@interface BJRangeViewController ()

@end

@implementation BJRangeViewController
...
- (void)setup {
    ...
    slider = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"kl.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:4]];
    [self addSubview:slider];
    
    rangeImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"S.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:4]];
    ...
    leftThumb.image = [UIImage imageNamed:@"poi2.png"];
    ...
    rightThumb.image = [UIImage imageNamed:@"poi.png"];
...
- (void)layoutSubviews {
    ...
    leftThumb.center = CGPointMake(inset + left, 45);
    rightThumb.center = CGPointMake(inset + right, 45);
}


- (void)setDisplayMode:(BJRangeSliderWithProgressDisplayMode2)mode {
    switch (mode) {
        case BJRSWPAudioRecordMode2:
            self.showThumbs = NO;
            self.showRange = NO;
        ...
        case BJRSWPAudioSetTrimMode2:
            self.showThumbs = YES;
            self.showRange = YES;
            self.showProgress = NO;
            break;
            
        case BJRSWPAudioPlayMode2:
            self.showThumbs = NO;
            self.showRange = YES;
            self.showProgress = YES;
