...
+ (void)setBackgroundColor:(UIColor *)color {
    [self sharedView].hudView.backgroundColor = [UIColor groupTableViewBackgroundColor];
    SVProgressHUDBackgroundColor = [UIColor groupTableViewBackgroundColor];
}

+ (void)setForegroundColor:(UIColor *)color {
    [self sharedView];
    SVProgressHUDForegroundColor = [UIColor groupTableViewBackgroundColor];;
}
