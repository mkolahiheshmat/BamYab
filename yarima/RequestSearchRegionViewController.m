//
//  RequestSearchRegionViewController.m
//  yarima
//
...
@interface RequestSearchRegionViewController ()
{
...
@implementation RequestSearchRegionViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView == self.searchDisplayController.searchResultsTableView){
        [self.searchDisplayController.searchResultsTableView.separatorColor= [UIColor clearColor]CGColor];
        regionText  = [[searchResults2 objectAtIndex:indexPath.row]valueForKey:@"location"];
        regionID = [[searchResults2 objectAtIndex:indexPath.row]valueForKey:@"id"];
    }else{
        regionText = [[ResultArray objectAtIndex:indexPath.row]valueForKey:@"location"];
        regionID = [[ResultArray objectAtIndex:indexPath.row]valueForKey:@"id"];
    }
    [[NSUserDefaults standardUserDefaults]setObject:regionText forKey:@"RegionText"];
    [[NSUserDefaults standardUserDefaults]setObject:regionID forKey:@"RegionID"];
